...
class Config(object):
    ...
    BLACK_IMG = getenv("BLACK_IMG", "https://telegra.ph/file/77d94f66f1aa463271275.jpg")        # black image for progress
    BOT_NAME = getenv("BOT_NAME", "Zaidvcplayer")   # dont put fancy texts here.
    BOT_PIC = getenv("BOT_PIC", "https://telegra.ph/file/2a91f50d54e57b4a7c7f6.jpg")           # put direct link to image here
